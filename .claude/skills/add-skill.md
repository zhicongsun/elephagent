...
2. Run `python3 agentmem.py skill add <name>` in the project root
...
4. Run `python3 agentmem.py build` to generate platform files
...
- Use `--force` to overwrite an existing skill: `python3 agentmem.py skill add <name> --force`
